...
//	$res_check=q("SELECT * FROM payment_notification_messages4 WHERE ipn_track_id = '".$ipn_track_id."'", $dbshop, __FILE__, __LINE__);
//	if (mysqli_num_rows($res_check)==0)
	{
		...
		$res_insert = q_insert("payment_notification_messages4", $insert_data, $dbshop, __FILE__, __LINE__);
