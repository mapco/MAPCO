...
function play_video(container_id, video_url, autostart)
{
	flowplayer(container_id,
			   { src: "http://www.mapco.de/modules/player/flowplayer-3.2.7.swf", wmode: "transparent" },
			   { clip: {autoPlay: autostart, autoBuffering: true}, playlist: [video_url] });
