...
//Ab hier: Bestelldetails
	...
	{
		if ( <?php echo $_SESSION['id_user']?> == 28625 ) alert('Hallo!');
		var check_service = 1;
		for (i=0; i<kritcnt; i++)
		{
...
//******************************************************************************************************	
	...
	function update_car_data(order_data, customer_vehicle_id, i)
	{
		...
		for(j=0; j<order_data["item"][i]["criteria"].length; j++)
		{
			...
			{
				if($("#" + order_data["item"][i]["criteria"][j]["KritNr"] + order_data["item"][i]["criteria"][j]["KritWert"] + order_data["item"][i]["OrderItemID"]).length==1)
				{
					...
					UserKritBez[cnt_input]   = $("#" + order_data["item"][i]["criteria"][j]["KritNr"] + order_data["item"][i]["criteria"][j]["KritWert"] + order_data["item"][i]["OrderItemID"]).val().trim();
