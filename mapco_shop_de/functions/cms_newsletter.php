<?php
	...
	if (!function_exists("newsletter"))
	{
		function newsletter($usermail, $id_article, $title, $article, $introduction, $firstmod, $lang)
		{
			...
			$mail .= '<body>';
			$mail .= '<!-- Link Start -->';
			$mail .= '<p align="center" style="font-size:9px; font-family:Arial, Helvetica, sans-serif; color:#333333";>Wird der Newsletter nicht korrekt angezeigt? <a target="_blank" href="http://www.mapco.de/'.$lang.'/newsletter/'.$id_article.'/'.url_encode($title).'">Klicken Sie hier!</a></p>';
			$mail .= '<!-- Link Stop -->';
			...
			$mail .= '<td align="right" style="font-size:12px; width:30%; font-family:Arial, Helvetica, sans-serif;"><a href="http://www.mapco.de/'.$lang.'/" target="_blank">Startseite</a> | <a href="http://www.mapco.de/'.$lang.'/online-shop/mein-konto/" target="_blank">Login</a></td>';
			$mail .= '</tr>';
			$mail .= '<tr>';
			...
			if(isset($usermail) and $usermail!="-")
			{
				...
				$mail .= '<p style="font-size:9px; font-family:Arial, Helvetica, sans-serif; color:#333333";>Wenn Sie diesen Newsletter nicht mehr beziehen möchten, können Sie sich <a href="http://www.mapco.de/'.$lang.'/unsubscribe/'.$usermail.'" target="_blank">hier abmelden</a>.</p><br />';
				$mail .='</td>';
				$mail .= '</tr>';
			}
			$mail .= '<tr>';
