					...
					if ($mailto_agent) 
					{
						...
						else
						{
							...
							if($order_mail==1)
							{
								...
								send_html_mail_ma("mwosgien@mapco.de", "Neue Bestellung im Online-Shoprc", $text13);
							}
						}
					}
				}
					...
					if ($mailto_agent) 
					{
						...
						elseif ($shop_id==8)
						{
							...
							if($order_mail==1)
							{
								...
								send_html_mail_ma($mail, "Neue Bestellung im Online-Shop8", $text13);
							}
						}
						else
						{
							...
							//send_html_mail_ma("bestellung@mapco-shop.de", "Neue Bestellung im Online-Shop", $text13);
							send_html_mail_ma("mwosgien@mapco.de", "Neue Bestellung im Online-Shopbork", $text13);
						}
					}
				}
//************************************************************************************************************************************
...
//**********************************************************************************************************			
	 ...
	 mail_order2(1749483, false, true)
?>