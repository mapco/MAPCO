...
//		alert(theForm.elements.length);
	...
	function order_send($id_order, approved)
	{
		...
		wait_dialog_show();
		$.post("<?php echo PATH; ?>soa2/", { API:"idims", APIRequest:"OrderSend_test", id_order:$id_order, approved: approved }, function($data)
		{
			wait_dialog_hide();
...
//		alert($id_order);
		wait_dialog_show();
		$.post("<?php echo PATH; ?>soa/", { API:"idims", Action:"OrderSend_test", id_order:$id_order }, function($data)
		{
			show_status2($data);
			return;
			wait_dialog_hide();
