<?php
	...
	if ($_POST["form_button"]=="Benutzerprofil löschen")
    {
		...
		{
			q("DELETE FROM users WHERE id_user=".$_POST["form_id_user"]." LIMIT 1;", $dbweb, __FILE__, __LINE__);
	...
	echo '<a href="backend_cms_userrole_editor.php" title="Neues Benutzerprofil anlegen"><img src="images/icons/24x24/user_add.png" alt="Neues Benutzerprofil anlegen" title="Neues Benutzerprofil anlegen" /></a>';
	echo '</h1>';
	...
	while ($row=mysqli_fetch_array($results))
	{
		...
		echo '		<a href="backend_cms_userrole_editor.php?id_userrole='.$row["id_userrole"].'" title="Benutzerprofil bearbeiten"><img src="images/icons/24x24/user.png" alt="Benutzerprofil bearbeiten" title="Benutzerprofil bearbeiten" /></a>';
		echo '	</td>';
		echo '</tr>';
	}
	echo '</table>';
