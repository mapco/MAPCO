...
echo '	<td style="vertical-align:top;">';
	...
	echo '<a'.$style.' class="formbutton" href="'.PATH.'kontakt-inland/">Inland</a>';
	echo '&nbsp; &nbsp;';

	if ( strpos($_GET["url"], "export") !== false ) $style=' style="font-weight:bold;"'; else $style='';
	echo '<a'.$style.' class="formbutton" href="'.PATH.'kontakt-export/">Export</a>';
	echo '&nbsp; &nbsp;';

	if ( strpos($_GET["url"], "online") !== false ) $style=' style="font-weight:bold;"'; else $style='';
	echo '<a'.$style.' class="formbutton" href="'.PATH.'kontakt-online/">Online-Handel</a>';
	echo '<br style="clear:both;" />';
	echo '<br style="clear:both;" />';

	//domestic market contacts
	if ( strpos($_GET["url"], "inland") !== false )
	{
	...
	//export contacts
	if ( strpos($_GET["url"], "export") !== false )
	{
		if ($_GET["lang"]=="pl")
		{
			show_person(1234672);
	...
	//online contacts
	if ( strpos($_GET["url"], "online") !== false )
	{
