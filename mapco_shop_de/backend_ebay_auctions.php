...
<script language="javascript">
	...
	{
		window.location.href="http://www.mapco.de/backend_ebay_auctions.php?lang=de&id_menuitem=173&account=<?php echo $_GET["account"]; ?>";
	}
	...
	function view(text)
	{
		...
		if (text2==text)
		{
			...
			var response=ajax('modules/backend_ebay_auctions_actions.php?action=view&lang='+encodeURIComponent('<?php echo $_GET["lang"]; ?>')+'&id_menuitem='+id_menuitem+'&filter='+filter+'&needle='+encodeURIComponent(needle)+'&fotostatus='+fotostatus, false);
