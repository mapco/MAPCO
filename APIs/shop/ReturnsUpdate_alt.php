...
// EINGABEN LEEREN
	...
	$sql.="state='".$_POST["state"]."', platform='".$_POST["platform"]."', userid='".$userid."', buyername='".$_POST["buyerName"]."', MPU='".$_POST["MPU"]."', articlegroup='".$_POST["article_group"]."', quantity='".$_POST["quantity"]."',  invoiceID='".$_POST["invoiceID"]."', rAction='".$_POST["rAction"]."', rReason='".$_POST["rReason"]."', rReason_detail='".$_POST["rReason_detail"]."', exchange_MPU='".$exchange_MPU."', exchange_quantity='".$exchange_quantity."', date_exchange_sent='".$date_exchange_sent."',date_order=".dateConverter($_POST["date_order"]).", date_announced='".dateConverter($_POST["date_announced"])."', date_return='".dateConverter($_POST["date_return"])."', date_refund='".dateConverter($_POST["date_refund"])."', date_refund_reshipment='".dateConverter($_POST["date_refund_reshipment"])."', date_r_IDIMS='".dateConverter($_POST["date_r_IDIMS"])."', ebay_demand_closing1='".dateConverter($_POST["date_demandEbayClosing1"])."', ebay_demand_closing2='".dateConverter($_POST["date_demandEbayClosing2"])."', ebay_fee_refund='".$_POST["ebayFeeRefundOK"]."', refund='".$refund."', refund_reshipment='".$refund_reshipment."', lastmod='".time()."', lastmod_user='".$_SESSION["id_user"]."'";
