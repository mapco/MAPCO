...
//SUMS
	...
	*/
		$xmldata.="	<completeTotalGrossFC>".number_format($orderTotalGrossFC-$sum_returnitemsFCgross, 2,",","")."</completeTotalGrossFC>\n";
		$xmldata.="	<completeTotalGross>".number_format($orderTotalGross-$sum_returnitemsEURgross, 2,",","")."</completeTotalGross>\n";
		$xmldata.="	<completeTotalNetFC>".number_format($orderTotalNetFC-$sum_returnitemsFCnet, 2,",","")."</completeTotalNetFC>\n";
		$xmldata.="	<completeTotalNet>".number_format($orderTotalNet-$sum_returnitemsEURnet, 2,",","")."</completeTotalNet>\n";
