<?php
	...
	{
		echo '<crm_get_customers_from_listResponse>'."\n";
	...
	//GET LIST OWNER
	//Get Customers in list from CMS USER
	$notes=array();
	...
	{
		if ($row_lists["id_list"]==$_POST["id_list"]) $list_owner=$row_lists["firstmod_user"];
	...
	$res_lists_customer=q("SELECT * FROM crm_costumer_lists_customers WHERE firstmod_user=29072;",$dbweb, __FILE__, __LINE__);
...
echo "<listowner>".$list_owner."</listowner>\n";
	echo $xmldata;
echo "</crm_get_customers_from_listResponse>";
