<?php
	...
	q("UPDATE crm_communications SET communtication_type = '".mysql_real_escape_string($_POST["contacttype"], $dbweb)."', communication_text = '".mysql_real_escape_string($_POST["note"], $dbweb)."', reminder = ".$reminder.", lastmod = ".time().", lastmod_user= ".$_SESSION["id_user"]." WHERE id_communication = ".$_POST["communication_id"].";", $dbweb, __FILE__, __LINE__);
