<?php
	...
	q("INSERT INTO crm_customer_notes (customer_id, note, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$_POST["customer_id"].", '".mysql_real_escape_string($_POST["note"], $dbweb)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
