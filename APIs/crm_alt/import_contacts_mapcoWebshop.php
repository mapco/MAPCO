...
echo sizeof($account_user_id);
	...
	foreach($account_user_id as $accountuserid)
	{
		...
		$res=q("INSERT INTO crm_customers (company, name, street1, street2, zip, city, country, phone, mobile, fax, mail, gewerblich, firstmod, firstmod_user, lastmod, lastmod_user) VALUES ('".mysql_real_escape_string($crm_customer_address["company"], $dbweb)."', '".mysql_real_escape_string($crm_customer_address["name"], $dbweb)."', '".mysql_real_escape_string($crm_customer_address["street1"], $dbweb)."', '".mysql_real_escape_string($crm_customer_address["street2"], $dbweb)."','".mysql_real_escape_string($crm_customer_address["zip"], $dbweb)."','".mysql_real_escape_string($crm_customer_address["city"], $dbweb)."', '".mysql_real_escape_string($crm_customer_address["country"], $dbweb)."','".mysql_real_escape_string($crm_customer_phone, $dbweb)."','".mysql_real_escape_string($crm_customer_mobile, $dbweb)."','".mysql_real_escape_string($crm_customer_fax, $dbweb)."','".mysql_real_escape_string($crm_customer_mail, $dbweb)."', ".$crm_customer_address["gewerblich"].", ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
		
		$crm_user_ID=mysql_insert_id($dbweb);
		
		//Account anlegen
		$res=q("INSERT INTO crm_customer_accounts (crm_customer_id, account, account_type, account_user_id, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$crm_user_ID.", 1, 2, '".mysql_real_escape_string($accountuserid, $dbweb)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
		...
		if (isset($bill_company[$accountuserid])) {
			...
			{
				$res=q("INSERT INTO crm_address (crm_customer_id, crm_customer_account_id, address_type, company, name, street1, street2, zip, city, country, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$crm_user_ID.", ".$id_customer_account.", 4, '".mysql_real_escape_string($bill_company[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($bill_firstname[$accountuserid][$i].' '.$bill_lastname[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($bill_street[$accountuserid][$i].' '.$bill_number[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($bill_additional[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($bill_zip[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($bill_city[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($bill_country[$accountuserid][$i], $dbweb)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
			}
		}
			//SHIP
		if (isset($ship_company[$accountuserid])) {
			...
			{
				$res=q("INSERT INTO crm_address (crm_customer_id, crm_customer_account_id, address_type, company, name, street1, street2, zip, city, country, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$crm_user_ID.", ".$id_customer_account.", 2, '".mysql_real_escape_string($ship_company[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($ship_firstname[$accountuserid][$i].' '.$ship_lastname[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($ship_street[$accountuserid][$i].' '.$ship_number[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($ship_additional[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($ship_zip[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($ship_city[$accountuserid][$i], $dbweb)."', '".mysql_real_escape_string($ship_country[$accountuserid][$i], $dbweb)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
			}
		}
			//PHONE
		if (isset($phone[$accountuserid])) {
			...
			{
				$res=q("INSERT INTO crm_numbers (crm_customer_id, crm_customer_account_id, number_type, number, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$crm_user_ID.", ".$id_customer_account.", 2, '".mysql_real_escape_string($phone[$accountuserid][$i], $dbweb)."',".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
			}
		}
			// MOBILE
		if (isset($mobile[$accountuserid])) {
			...
			{
				$res=q("INSERT INTO crm_numbers (crm_customer_id, crm_customer_account_id, number_type, number, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$crm_user_ID.", ".$id_customer_account.", 4, '".mysql_real_escape_string($mobile[$accountuserid][$i], $dbweb)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
			}
		}
			// FAX
		if (isset($fax[$accountuserid])) {
			...
			{
				$res=q("INSERT INTO crm_numbers (crm_customer_id, crm_customer_account_id, number_type, number, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$crm_user_ID.", ".$id_customer_account.", 6, '".mysql_real_escape_string($fax[$accountuserid][$i], $dbweb)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
			}
		}
			// MAIL
		if (isset($mail[$accountuserid])) {
			...
			{
				$res=q("INSERT INTO crm_numbers (crm_customer_id, crm_customer_account_id, number_type, number, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$crm_user_ID.", ".$id_customer_account.", 8, '".mysql_real_escape_string($mail[$accountuserid][$i], $dbweb)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
			}
		}
	}
