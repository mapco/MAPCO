<?php
	...
	q("INSERT INTO crm_communications (customer_id, communtication_type, communication_text, reminder, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$_POST["customer_id"].", '".mysql_real_escape_string($_POST["contacttype"], $dbweb)."', '".mysql_real_escape_string($_POST["note"], $dbweb)."', ".$reminder.", ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
