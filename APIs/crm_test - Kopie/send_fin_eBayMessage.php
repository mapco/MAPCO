<?php
	...
	$message.='Vielen Dank!'.chr(13).chr(10).chr(13).chr(10);	
	$message.='Sofern Sie uns bereits Ihre Fahrzeugdaten mitgeteilt haben, brauchen Sie auf diese Nachricht nicht zu antworten.';
