<?php
	...
	q("UPDATE crm_customer_notes SET note = '".mysqli_real_escape_string($dbweb,$_POST["note"])."', lastmod = ".time().", lastmod_user = ".$_SESSION["id_user"]." WHERE id_note = ".$_POST["note_id"].";", $dbweb, __FILE__, __LINE__);
