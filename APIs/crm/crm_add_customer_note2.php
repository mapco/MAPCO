<?php
	...
	q("INSERT INTO crm_customer_notes2 (customer_id, order_id, note, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$_POST["customer_id"].", ".$order_id.", '".mysqli_real_escape_string($dbweb, $_POST["note"])."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
