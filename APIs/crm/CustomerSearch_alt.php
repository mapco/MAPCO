<?php
	...
	{
		$required=array("site_id" => "numericNN", "qry_string" => "textNN");
	...
	*/
		...
		$shops = array();
		$res_shops = q("SELECT * FROM shop_shops WHERE site_id = ".$_POST["site_id"]." AND active = 1;", $dbshop, __FILE__, __LINE__);
