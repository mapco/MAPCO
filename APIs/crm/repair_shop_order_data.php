<?php
	...
	$shop_order=array();
	$res_shop_order=q("SELECT * FROM shop_orders WHERE foreign_OrderID = '".$ebay_orders["OrderID"]."';", $dbshop, __FILE__, __LINE__);
...
//CUSTOMER KNOWN CHECK
		...
		$res_ins=q("INSERT INTO cms_users (shop_id, site_id, username, usermail, name, origin, password, user_token, userrole_id, language_id, active, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$shop["parent_shop_id"].", ".$site_id.", '".mysqli_real_escape_string($dbweb, $cms_username)."', '".mysqli_real_escape_string($dbweb, $usermail)."', '".mysqli_real_escape_string($dbweb, $ebay_orders["ShippingAddressName"])."', '".mysqli_real_escape_string($dbweb, $ebay_orders["ShippingAddressCountry"])."','".mysqli_real_escape_string($dbweb, createPassword(8))."', '".mysqli_real_escape_string($dbweb, createPassword(50))."',5,1,1, ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
		...
		{
//		echo "INSERT ACCOUNT";	
			$res_ins=q("INSERT INTO crm_customer_accounts3 (cms_user_id, shop_id, shop_user_id, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$cms_user_id.", ".$shop["id_shop"].",'".mysqli_real_escape_string($dbweb, $ebay_orders["BuyerUserID"])."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
		...
		if ($cms_user_id!=0 && $address_id==0)
		{
			...
			{
				$res=q("INSERT INTO shop_bill_adr (user_id, shop_id, foreign_address_id, firstname, lastname, street, number, additional, zip, city, country, country_id, standard, active) VALUES (".$cms_user_id.", ".$shop["id_shop"].", '".mysqli_real_escape_string($dbshop, $ebay_orders["ShippingAddressAddressID"])."', '".mysqli_real_escape_string($dbshop, $bill_firstname)."', '".mysqli_real_escape_string($dbshop, $bill_lastname)."', '".mysqli_real_escape_string($dbshop, $bill_street1)."', '".mysqli_real_escape_string($dbshop, $bill_streetNumber)."', '".mysqli_real_escape_string($dbshop, $ebay_orders["ShippingAddressStreet2"])."', '".mysqli_real_escape_string($dbshop, $ebay_orders["ShippingAddressPostalCode"])."', '".mysqli_real_escape_string($dbshop, $bill_city)."', '".mysqli_real_escape_string($dbshop, $ebay_orders["ShippingAddressCountryName"])."', ".$countries[$ebay_orders["ShippingAddressCountry"]].", 1,1 );", $dbshop, __FILE__, __LINE__);
		...
		if ($cms_user_id!=0 && $number_id==0)
		{
			if ($usermail!="Invalid Request" && $usermail!="")
			{
				$res_ins=q("INSERT INTO crm_numbers3 (cms_user_id, shop_id, number_type, number, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$cms_user_id.", ".$shop["id_shop"].", 7, '".mysqli_real_escape_string($dbweb, $usermail)."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
		...
		if ($cms_user_id!=0 && $phone_id==0)
		{
			if ($ebay_orders["ShippingAddressPhone"]!="Invalid Request" && $ebay_orders["ShippingAddressPhone"]!="")
			{
				$res_ins=q("INSERT INTO crm_numbers3 (cms_user_id, shop_id, number_type, number, firstmod, firstmod_user, lastmod, lastmod_user) VALUES (".$cms_user_id.", ".$shop["id_shop"].", 1, '".mysqli_real_escape_string($dbweb,  ebay_orders["ShippingAddressPhone"])."', ".time().", ".$_SESSION["id_user"].", ".time().", ".$_SESSION["id_user"].");", $dbweb, __FILE__, __LINE__);
