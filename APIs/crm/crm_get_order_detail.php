...
/*	
	if ($order[0]["combined_with"]>0)
	{
		...
		$res_orders=q("SELECT * FROM shop_orders WHERE combined_with = ".$order[0]["combined_with"]." AND NOT id_order = ".$order[0]["combined_with"].";", $dbshop, __FILE__, __LINE__);
...
*/
	...
	if (mysqli_num_rows($res_shop_bill_adr)>0)
	{
		...
		$xmldata.="	<shop_bill_adr_company><![CDATA[".$row_shop_bill_adr["company"]."]]></shop_bill_adr_company>\n";
		$xmldata.="	<shop_bill_adr_firstname><![CDATA[".$row_shop_bill_adr["firstname"]."]]></shop_bill_adr_firstname>\n";
		$xmldata.="	<shop_bill_adr_lastname><![CDATA[".$row_shop_bill_adr["lastname"]."]]></shop_bill_adr_lastname>\n";
		$xmldata.="	<shop_bill_adr_street><![CDATA[".$row_shop_bill_adr["street"]."]]></shop_bill_adr_street>\n";
		$xmldata.="	<shop_bill_adr_number><![CDATA[".$row_shop_bill_adr["number"]."]]></shop_bill_adr_number>\n";
		$xmldata.="	<shop_bill_adr_additional><![CDATA[".$row_shop_bill_adr["additional"]."]]></shop_bill_adr_additional>\n";
		$xmldata.="	<shop_bill_adr_city><![CDATA[".$row_shop_bill_adr["city"]."]]></shop_bill_adr_city>\n";
		$xmldata.="	<shop_bill_adr_zip><![CDATA[".$row_shop_bill_adr["zip"]."]]></shop_bill_adr_zip>\n";
		$xmldata.="	<shop_bill_adr_country><![CDATA[".$row_shop_bill_adr["country"]."]]></shop_bill_adr_country>\n";
		$xmldata.="	<shop_bill_adr_country_id><![CDATA[".$row_shop_bill_adr["country_id"]."]]></shop_bill_adr_country_id>\n";
...
//		else
		...
		$xmldata.="	<orderItemsTotalNet>".number_format($orderItemsTotalGross, 2,",",".")."</orderItemsTotalNet>\n";
