<?php
	...
	q("UPDATE crm_costumer_lists SET title = '".mysqli_real_escape_string($dbweb,$_POST["title"])."', private = ".$_POST["private"]." WHERE id_list = ".$_POST["listID"].";", $dbweb, __FILE__, __LINE__);
