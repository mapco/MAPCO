<?php
	...
	{
		if ( $payment["method"]==2 && (!isset($_POST["Payments_TransactionID"]) || $_POST["Payments_TransactionID"]==""))
		{
			echo '<crm_set_payment_stateResponse>'."\n";
			echo '	<Ack>Failure</Ack>'."\n";
			echo '	<Error>'."\n";
...
*/
	...
	*/
	...
	else
	{
		...
		$status_date=$order[0]["status_date"];
	}
	...
	/*
			$responseXml = post(PATH."soa2/", array("API" => "shop", "APIRequest" => "OrderDepositAdd", "order_id" => $_POST["OrderID"]));
...
*/	
	...
	/*	
		...
		if (($_POST["PaymentTypeID"]==2 || $_POST["PaymentTypeID"]==3) && $shop["shop_type"]==2)
		{
			//UPDATE EBAY
	...
	// CALL PAYMENTNOTIFICATIONHANDLER
		...
		{
			//RECHNUNG 
			case 1: $postfields["mode"] = ""; break;
			//VORKASSE
			case 2: $postfields["mode"] = "BankTransfer"; $postfields["orderid"] = $_POST["OrderID"]; $postfields["payment_total"] = $pn_total; $postfields["accounting_date"] = time(); break;
			//NACHNAHME
			case 3: $postfields["mode"] = "COD"; $postfields["orderid"] = $_POST["OrderID"]; $postfields["payment_total"] = $pn_total; $postfields["accounting_date"] = time(); break;
			//PAYPAL
			case 4: $postfields["mode"] = "PayPal"; $postfields["orderid"] = $_POST["OrderID"]; break;
			//KREDITKARTE
			case 5: $postfields["mode"] = "CreditCard"; break;
			//SOFORTÜBERWEISUNG
			case 6: $postfields["mode"] = "Sofort"; break;
			//BARZAHLUNG
			case 7: $postfields["mode"] = "COP"; break;
			
			default : $postfields["mode"]="";
		}
