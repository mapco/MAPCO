...
while($row=mysql_fetch_array($res))
{
	...
	//-> ITEMDATA
	$nvpstr.="&L_PAYMENTREQUEST_0_AMT".$cartItemCount."=".$price["net"];
...
$nvpstr.="&PAYMENTREQUEST_0_SHIPPINGAMT=".$_SESSION["shipping_costs"];
$nvpstr.="&PAYMENTREQUEST_0_TAXAMT=".$tax;
$nvpstr.="&PAYMENTREQUEST_0_AMT=".$orderTotal;

	$_SESSION["PAYMENTREQUEST_0_ITEMAMT"]=$cartItemTotal;
	$_SESSION["PAYMENTREQUEST_0_SHIPPINGAMT"]=$_SESSION["shipping_costs"];
